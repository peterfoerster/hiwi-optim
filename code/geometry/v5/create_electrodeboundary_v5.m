function [electrode_boundary] = create_electrodeboundary_v5 ()
   % photocathode
   p1 = [190e-3 0];
   p2 = [p1(1) 5e-3];
   ...
   electrode_boundary(8) = nrbreverse(electrode_boundary(8));

   sang = pi;
   eang = 3*pi/2;
   electrode_boundary(9) = nrbcirc(radius, center, sang, eang);
   electrode_boundary(9) = nrbreverse(electrode_boundary(9));
   ...
   p1 = [100e-3 35e-3];
   p2 = nrbeval(electrode_boundary(10), 0);
