function nrbplot_dat3D_line (nurbs, subd, filename, varargin)
%
...
if (iscell (nurbs.knots))
 ...
 elseif (size (nurbs.knots,2) == 3) % plot the boundaries of a NURBS volume
  ...
  write_dat3D_line([filename '1'], X, Y, Z);

  write_dat3D_line([filename '2'], X, Z, -Y);

  write_dat3D_line([filename '3'], X, -Y, Z);

  write_dat3D_line([filename '4'], X, Z, Y);
