...
function [errh1, errl2, errh1s] = sp_h1_error_ref (msh_ref, space_ref, u_ref, u_conv, space_conv, geometry, iptc, filename)
errl2 = 0; errh1s = 0; err = [];

% compute points for plotting of error
[eu, F] = sp_eval (u_ref, space_ref, geometry, msh_ref.breaks);
...
% returns the correct X Y and err
msh_to_vtk_cell (F, err, [filename '/' filename '_' num2str(iptc) '.vts'], 'err_h1');
