function [ptcs_vac, ptcs_el] = create_ptcs_v6 (electrode, anode_ring, inner_insulator, outer_insulator, vacuumchamber, domain_vac, domain_el)
   ...
   ptcs_vac(5) = nrbcoons(anode_ring(14), anode_ring(13), anode_ring(11), anode_ring(3));
   ...
   ptcs_vac(8) = nrbcoons(electrode(3), anode_ring(7), domain_vac(6), domain_vac(7));
   ptcs_vac(9) = nrbcoons(electrode(4), anode_ring(6), domain_vac(7), domain_vac(8));
   ...
   ptcs_vac(12) = nrbcoons(nrbdegelev(domain_vac(11), 1), domain_vac(10), anode_ring(3), vacuumchamber(4));
   ptcs_vac(13) = nrbcoons(nrbdegelev(domain_vac(12), 1), domain_vac(11), anode_ring(4), vacuumchamber(5));
   ...
   ptcs_vac(16) = nrbcoons(domain_vac(15), domain_vac(14), electrode(8), vacuumchamber(7));
   ptcs_vac(17) = nrbcoons(domain_vac(16), domain_vac(15), electrode(9), vacuumchamber(8));
