function [vacuumchamber_inside] = divide_vacuumchamber_v2 (electrode_boundary, vacuumchamber)
  ...
  p1 = nrbeval(vacuumchamber_inside(11), 0);
  ...
  p2 = nrbeval(vacuumchamber_inside(14), 0);
  ...
  p2 = nrbeval(vacuumchamber_inside(21), 1);
  ...
  p2 = nrbeval(electrode_boundary(27), 1);
  vacuumchamber_inside(25) = nrbline(p1, p2);

  % between insulators
  p1 = nrbeval(vacuumchamber_inside(23), 1);
  p2 = nrbeval(electrode_boundary(15), 0);
