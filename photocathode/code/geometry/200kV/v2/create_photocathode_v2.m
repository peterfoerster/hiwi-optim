...
filename = 'photocathode_200kV_v2';

electrode_boundary = create_electrodeboundary_v2();
...
vacuumchamber = create_vacuumchamber_v2 (electrode_boundary);
...
vacuumchamber_inside = divide_vacuumchamber_v2 (electrode_boundary, vacuumchamber);
...
hold off;
return
ptcs = create_ptcs_v2 (electrode_boundary, vacuumchamber, vacuumchamber_inside);
...
hold off;
return
write_geometryfile_v2 (ptcs, [filename '.txt']);
