function [vacuumchamber] = create_vacuumchamber_v2 (electrode_boundary)
...
p1 = nrbeval(electrode_boundary(26), 1);
...
% insulator
p1 = nrbeval(electrode_boundary(26), 0);
...
p2 = nrbeval(electrode_boundary(27), 0);
