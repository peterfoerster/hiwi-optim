function [electrode_boundary] = create_electrodeboundary_v2 ()
  % photocathode
  p1 = [190e-3 0];
  p2 = [p1(1) 5e-3];
  ...
  electrode_boundary(7) = nrbreverse(electrode_boundary(7));
  ...
  p1 = nrbeval(electrode_boundary(3), 1);
  p2 = nrbeval(electrode_boundary(4), 0.5);
  electrode_boundary(4) = nrbline(p1, p2);
  ...
  sang = 3*pi/4;
  eang = pi;
  electrode_boundary(12) = nrbcirc(radius, center, sang, eang);
  electrode_boundary(12) = nrbreverse(electrode_boundary(12));

  sang = pi;
  eang = 3*pi/2;
  electrode_boundary(13) = nrbcirc(radius, center, sang, eang);
  electrode_boundary(13) = nrbreverse(electrode_boundary(13));
  ...
  p1 = [100e-3 35e-3];
  p2 = nrbeval(electrode_boundary(14), 0);
  ...
  % lift
  p1 = nrbeval(electrode_boundary(18), 1);
  p2 = [185e-3 45e-3];
  electrode_boundary(19) = nrbline(p1, p2);

  p1 = [185e-3 30e-3];
  p2 = nrbeval(electrode_boundary(19), 1);
  ...
  p1 = [125e-3 20e-3];
  p2 = nrbeval(electrode_boundary(22), 0);
  electrode_boundary(23) = nrbline(p1, p2);

  % cable connection
  p1 = nrbeval(electrode_boundary(23), 0);
  p2 = [125e-3 21e-3];
  electrode_boundary(24) = nrbline(p1, p2);

  p1 = [75e-3 21e-3];
  p2 = nrbeval(electrode_boundary(24), 1);
  ...
  electrode_boundary(27) = nrbline(p1, p2);
end
