function [ptcs] = create_ptcs_v1 (electrode_boundary, vacuumchamber, vacuumchamber_inside)
   ...
   ptcs(16) = nrbcoons(vacuumchamber_inside(18), electrode_boundary(14), vacuumchamber_inside(22), vacuumchamber_inside(23));

   ptcs(17) = nrbcoons(vacuumchamber_inside(16), vacuumchamber_inside(21), vacuumchamber(15), vacuumchamber_inside(17));
   ptcs(18) = nrbcoons(vacuumchamber_inside(19), vacuumchamber_inside(18), vacuumchamber_inside(17), electrode_boundary(25));
   ptcs(19) = nrbcoons(vacuumchamber_inside(20), vacuumchamber_inside(16), vacuumchamber(16), nrbreverse(vacuumchamber_inside(19)));
   ptcs(20) = nrbcoons(vacuumchamber(18), vacuumchamber_inside(20), vacuumchamber(17), electrode_boundary(26));

   ptcs(21) = nrbcoons(electrode_boundary(24), electrode_boundary(15), vacuumchamber_inside(23), vacuumchamber_inside(24));
   ptcs(22) = nrbcoons(electrode_boundary(22), vacuumchamber_inside(25), electrode_boundary(23), electrode_boundary(21));
   ptcs(23) = nrbcoons(vacuumchamber_inside(25), vacuumchamber_inside(26), vacuumchamber_inside(24), electrode_boundary(20));
   ptcs(24) = nrbcoons(vacuumchamber_inside(26), electrode_boundary(18), electrode_boundary(16), electrode_boundary(19));
end
