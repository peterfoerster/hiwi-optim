function [vacuumchamber] = create_vacuumchamber_v1 (cathode_boundary)
...
p1 = nrbeval(cathode_boundary(24), 0);
...
% insulator
p1 = nrbeval(cathode_boundary(25), 0);
...
p2 = nrbeval(cathode_boundary(26), 0);
