function [vacuumchamber_inside] = divide_vacuumchamber_v1 (cathode_boundary, vacuumchamber)
   ...
   p2 = nrbeval(cathode_boundary(25), 1);
   vacuumchamber_inside(18) = nrbline(p1, p2);

   p1 = nrbeval(vacuumchamber_inside(16), 1);
   p2 = nrbeval(cathode_boundary(25), 0);
