function [] = write_geometryfile (outside_ptcs, filename)
  ...
  boundaries(1).patches = [1 2 3 4 5 6 7 9 10 10 10];
  boundaries(1).faces   = [3 3 3 1 1 4 4 4  1  2  4];

  boundaries(2).patches = [1 2 3 4 5 6 7 8 9];
  boundaries(2).faces   = [4 4 4 2 2 3 3 3 3];

  boundaries(3).patches = [1 9];
