...
\begin{figure}[H]
  \begin{center}
    \begin{subfigure}{0.4\textwidth}
      \input{figures/insulator/convergence_potential}
      \caption{Convergence of $L^2$-norm.}
      \label{fig:convergence_potential}
    \end{subfigure}
    \qquad \qquad
    \begin{subfigure}{0.4\textwidth}
      \input{figures/insulator/convergence_potential_offset}
...
\begin{figure}[H]
  \begin{center}
    \begin{subfigure}{0.4\textwidth}
      \input{figures/insulator/convergence_gradient}
      \caption{Convergence of $H^1$-norm.}
      \label{fig:convergence_gradient}
    \end{subfigure}
    \qquad \qquad
    \begin{subfigure}{0.4\textwidth}
      \input{figures/insulator/convergence_gradient_offset}
...
% does not work per cell but per grid point, thus use paraview export
% \begin{center}
% \begin{figure}[H]
%   \input{figures/insulator/error_elem_nsub=16}
%   \caption{Absolute error of the electric field on every element.}
