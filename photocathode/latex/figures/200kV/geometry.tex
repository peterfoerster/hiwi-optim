...
\begin{axis}[
  ...
  \addplot[surf, shader=interp, colormap/Blues, point meta min = 0, point meta max = 1] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_8.dat};
  ...
  \addplot[surf, shader=interp, colormap/Reds, point meta min = 0, point meta max = 1] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_15.dat};

  \addplot[surf, shader=interp] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_16.dat};

  \addplot[surf, shader=interp] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_17.dat};

  \addplot[surf, shader=interp, colormap/Reds, point meta min = 0, point meta max = 1] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_18.dat};

  \addplot[surf, shader=interp, colormap/Reds, point meta min = 0, point meta max = 1] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_19.dat};
  ...
  \addplot[surf, shader=interp] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_23.dat};

  \addplot[surf, shader=interp] table[point meta=\thisrow{c}]{figures/200kV/geometry/geometry_24.dat};
  ...
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries61.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries62.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries63.dat};
  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries64.dat};

  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries71.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries72.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries73.dat};
  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries74.dat};

  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries81.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries82.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries83.dat};
  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries84.dat};

  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries91.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries92.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries93.dat};
  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries94.dat};

  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries101.dat};
  ...
  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries104.dat};

  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries111.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries112.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries113.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries114.dat};

  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries121.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries122.dat};
  ...
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries131.dat};
  ...
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries152.dat};
  ...
  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries161.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries162.dat};
  ...
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries182.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries183.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries184.dat};

  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries191.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries192.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries193.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries194.dat};

  \addplot[color=brewerred] table{figures/200kV/boundary/boundaries201.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries202.dat};
  \addplot[color=black] table{figures/200kV/boundary/boundaries203.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries204.dat};

  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries211.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries212.dat};
  ...
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries221.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries222.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries223.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries224.dat};

  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries231.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries232.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries233.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries234.dat};

  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries241.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries242.dat};
  \addplot[color=brewergrey] table{figures/200kV/boundary/boundaries243.dat};
  \addplot[color=brewerblue] table{figures/200kV/boundary/boundaries244.dat};
