...
\begin{axis}[
  ...
  \addplot[surf, shader=faceted interp] table[point meta=1e-6*\thisrow{c}]{fig/v5_order=3/run18_degree=3_nsub=128/E_degree=3_nsub=128_6.dat};

  \addplot[surf, shader=faceted interp] table[point meta=1e-6*\thisrow{c}]{fig/v5_order=3/run18_degree=3_nsub=128/E_degree=3_nsub=128_7.dat};

  \addplot[surf, shader=faceted interp] table[point meta=1e-6*\thisrow{c}]{fig/v5_order=3/run18_degree=3_nsub=128/E_degree=3_nsub=128_8.dat};

  \addplot[surf, shader=faceted interp] table[point meta=1e-6*\thisrow{c}]{fig/v5_order=3/run18_degree=3_nsub=128/E_degree=3_nsub=128_9.dat};
