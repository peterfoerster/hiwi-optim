...
%   epsilon: cell array of coefficients
%
% OUTPUT:
%
...
%       gradv_iel = repmat (gradv_iel, [1,1,1,spu.nsh(iel)]);
      ...
      % investigate double sum
      % multiply the respective components of gradu_iel and gradv_iel with the correct coeffs first
